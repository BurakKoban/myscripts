aws ec2 describe-instances --instance-ids i-03ba009e085bcdfc0 --profile data_protection --region us-west-2
...
aws ec2 modify-instance-metadata-options --instance-id i-03ba009e085bcdfc0 --profile data_protection --region us-west-2 \
