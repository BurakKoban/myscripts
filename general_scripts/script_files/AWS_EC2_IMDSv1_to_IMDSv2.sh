aws ec2 describe-instances --instance-ids i-086286b48f2d1a97c --profile neat_prod
...
aws ec2 modify-instance-metadata-options --instance-id i-086286b48f2d1a97c --profile neat_prod \
