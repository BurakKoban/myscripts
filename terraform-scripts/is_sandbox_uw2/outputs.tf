...
output "ebs_key_alias_arn" {
  ...
  value       = { for k, name in module.kms : k => name.alias_arn }["ebs"]
}

output "ebs_key_alias_name" {
  description = "The display name of the alias."
  value       = { for k, name in module.kms : k => name.alias_name }["ebs"] 
}
...
output "rds_key_alias_arn" {
  description = "The Amazon Resource Name (ARN) of the key alias"
  value       = { for k, name in module.kms : k => name.alias_arn }["rds"]
}

output "rds_key_alias_name" {
  description = "The display name of the alias."
  value       = { for k, name in module.kms : k => name.alias_name }["rds"]
}
...
output "secret_key_alias_arn" {
  description = "The Amazon Resource Name (ARN) of the key alias"
  value       = { for k, name in module.kms : k => name.alias_arn }["secret"]
}

output "secret_key_alias_name" {
  description = "The display name of the alias."
  value       = { for k, name in module.kms : k => name.alias_name }["secret"]
}
output "s3_key_arn" {
  description = "The Amazon Resource Name (ARN) of the key."
...
output "s3_key_alias_arn" {
  description = "The Amazon Resource Name (ARN) of the key alias"
  value       = { for k, name in module.kms : k => name.alias_arn }["s3"]
}

output "s3_key_alias_name" {
  description = "The display name of the alias."
  value       = { for k, name in module.kms : k => name.alias_name }["s3"]
}
...
output "key_pair_fingerprint" {
  ...
  value       = module.key_pair_ec2.key_pair_fingerprint
}
...
output "private_key_id" {
  ...
  value       = module.key_pair_ec2.private_key_id
}

output "private_key_openssh" {
  description = "Private key data in OpenSSH PEM (RFC 4716) format"
  value       = module.key_pair_ec2.private_key_openssh
  sensitive   = true
}

output "private_key_pem" {
  description = "Private key data in PEM (RFC 1421) format"
  value       = module.key_pair_ec2.private_key_pem
  sensitive   = true
}
...
output "public_key_fingerprint_md5" {
  ...
  value       = module.key_pair_ec2.public_key_fingerprint_md5
}
...
output "public_key_fingerprint_sha256" {
  ...
  value       = module.key_pair_ec2.public_key_fingerprint_sha256
}
...
output "public_key_openssh" {
  ...
  value       = module.key_pair_ec2.public_key_openssh
}

output "public_key_pem" {
  description = "Public key data in PEM (RFC 1421) format"
  value       = module.key_pair_ec2.public_key_pem
}