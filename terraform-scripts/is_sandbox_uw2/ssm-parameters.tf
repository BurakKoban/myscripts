...
data "aws_ssm_parameter" "tgw_igw_route_table_uw2" {
  provider = aws.ssm
  name     = "/devops/aws/511305002140/ca-central-1/vpc/tgw/tgw_igw_route_table_uw2"
}
...
// TGW route table Inbound-TGW-CA1
data "aws_ssm_parameter" "tgw_across_region_route_table_uw2" {
  provider = aws.ssm
  name     = "/devops/aws/511305002140/us-west-2/vpc/tgw/tgw_across_region_route_table_uw2"
}
...
data "aws_ssm_parameter" "resolver_rule_bcaa_bc_ca" {
  provider = aws.ssm
  name     = "/devops/aws/511305002140/us-west-2/route53/resolver_rules/resolver_rule_bcaa_bc_ca"
}
