...
data "aws_ssm_parameter" "tgw_igw_route_table_uw2" {
  provider = aws.ssm
  name     = "/devops/aws/511305002140/us-west-2/vpc/tgw/tgw_igw_route_table_uw2"
}
...
// TGW route table VPC-FW-Inspected
data "aws_ssm_parameter" "tgw_inspect_all_route_table_ca1" {
  provider = aws.ssm
  name     = "/devops/aws/511305002140/ca-central-1/vpc/tgw/tgw_inspect_all_route_table_ca1"
}

data "aws_ssm_parameter" "tgw_inspect_all_route_table_uw2" {
  provider = aws.ssm
  name     = "/devops/aws/511305002140/us-west-2/vpc/tgw/tgw_inspect_all_route_table_uw2"
}
