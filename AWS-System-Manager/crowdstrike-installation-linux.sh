...
curl -s -o /tmp/falcon-sensor_7.04.0-15907_amd64.deb https://d7gs59d1yhaqs.cloudfront.net/falcon-sensor_7.04.0-15907_amd64.deb
sudo dpkg -i /tmp/falcon-sensor_7.04.0-15907_amd64.deb
sudo /opt/CrowdStrike/falconctl -s --cid=CE518243D4DB48EBAF7E10B170F5A782-BE
sudo systemctl restart falcon-sensor
